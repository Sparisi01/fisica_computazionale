...
set title "Temperatura e pressione in funzione del tempo (FCC 864)" font ",16"
...
#set yrange [-1:6]
unset key
plot "../data/FCC_256/thermo_gas.dat" using 1:4 w l notitle, "../data/FCC_256/thermo_liquido.dat" using 1:4 w l lc 3 notitle, "../data/FCC_256/thermo_solido.dat" using 1:4 w l lc 4 notitle
