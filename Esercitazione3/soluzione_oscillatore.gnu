...
plot "plot_E_esplicito.dat" using 2:3 with lines title "Eulero Esplicito", \
"plot_E_implicito.dat" using 2:3 with lines title "Eulero Implicito", \
"plot_Trapezio.dat" using 2:3 with lines title "Trapezi", \
"plot_E_mk4.dat" using 2:3 with lines title "mk4"
